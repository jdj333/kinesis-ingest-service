...
locals {
  iam_role_name = substr(coalesce(var.iam_role_name, "${var.name}-node-group"),0,32)
...
resource "aws_iam_instance_profile" "this" {
  ...
  name        = var.iam_role_use_name_prefix ? null : local.iam_role_name
  name_prefix = substr(var.iam_role_use_name_prefix,0,38) ? substr("${local.iam_role_name}-",0,38) : null
  path        = var.iam_role_path
